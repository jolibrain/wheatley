...
class SlotLockingTransitionModel(TransitionModel):
    def __init__(
        ...
        super(SlotLockingTransitionModel, self).__init__(
    ...
    def run(self, state, node_id, lock_slot):  # noqa
        ...
        if not machine_occupancy:
            ...
            if job_availability_time < machine_occupancy[0][0] and (
                not self.slot_availability[machine_id]
                or (self.slot_availability[machine_id][0] == 1)
            ):
                ...
                if index == -1:
                    ...
                    self.slot_availability[machine_id].insert(
                        index + 1, 0 if lock_slot else 1
                    )
