...
def test_rcpsp_c154_3():
    ...
    assert rcpsp3.resource_cons[rcpsp3.job_to_id(1)][rcpsp3.mode_to_id(1)] == [
        0,
        0,
        0,
        0,
    ]
    assert rcpsp3.resource_cons[rcpsp3.job_to_id(2)][rcpsp3.mode_to_id(1)] == [
        6,
        0,
        0,
        1,
    ]
    assert rcpsp3.resource_cons[rcpsp3.job_to_id(2)][rcpsp3.mode_to_id(2)] == [
        0,
        10,
        8,
        0,
    ]
    assert rcpsp3.resource_cons[rcpsp3.job_to_id(2)][rcpsp3.mode_to_id(3)] == [
        0,
        8,
        8,
        0,
    ]
    assert rcpsp3.resource_cons[rcpsp3.job_to_id(3)][rcpsp3.mode_to_id(1)] == [
        6,
        0,
        0,
        5,
    ]
    assert rcpsp3.resource_cons[rcpsp3.job_to_id(18)][rcpsp3.mode_to_id(1)] == [
        0,
        0,
        0,
        0,
